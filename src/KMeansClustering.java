...
public class KMeansClustering
{
    ...
    private static final double SAMPLES[][] = new double[100][100];
    ...
    private static void initialize()
    {
        ...
        centroids.add(new Centroid(2.0, 1.0)); // lowest set.
        centroids.add(new Centroid(3.0, 3.0)); // highest set.
        centroids.add(new Centroid(5.0, 6.0)); // highest set.
        System.out.print("\n");
        ...
        for (int i = 0 ; i < 100 ; i++){
            for (int j = 0 ; j < 100 ; j++) {
                SAMPLES[i][j] = ThreadLocalRandom.current().nextDouble(randomMin, randomMax + 1);
            }
        }
    ...
    private static void calcNewCentroids() {
        for(int i = 0; i < NUM_CLUSTERS; i++)
        {
            int totalX = 0;
            int totalY = 0;
